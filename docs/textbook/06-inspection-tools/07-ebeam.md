...
|---|---|---|---|
| **VG BVC** | gate via 亮（應該暗） | MDMG short（>50% 的 case）| [Vol 2 MOL Ch 6.3](../02-mol/06-defect-kingdom.md) |
| | | HK pinhole / gate breakdown | [Vol 1 FEOL Ch 8.9](../01-feol/08-replacement-metal-gate.md) |
| | | Gate-S/D short via spacer | [Vol 1 FEOL Ch 5](../01-feol/05-dummy-gate-spacer.md) |
| | | MP overlay 偏到 spacer/CESL/epi | [Vol 2 MOL Ch 4.6](../02-mol/04-mp-contact.md) |
