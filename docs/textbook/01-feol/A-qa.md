...
**參考**：
- Plummer, J. D. et al. (2000). *Silicon VLSI Technology*, Prentice Hall, Ch. 7.
- Loubet, N. et al. (2017). *Stacked nanosheet gate-all-around transistor to enable scaling beyond FinFET*. VLSI Symposium.（IBM stacked nanosheet）
- Mertens, H. et al. (2016). *Vertically stacked gate-all-around Si nanowire CMOS transistors with dual work function metal gates*. IEDM.（imec stacked nanowire）
- Weckx, P. et al. (2019). *Novel forksheet device architecture as ultimate logic scaling device towards 2nm*. IEDM.（imec forksheet）
...
**參考**：
- Ghani, T. et al. (2003). *A 90nm high volume manufacturing logic technology featuring novel 45nm gate length strained silicon CMOS transistors*. IEDM Tech. Dig., pp. 978–980.（Intel 首次在 90nm 引入 SiGe S/D stressor）
- Thompson, S. E. et al. (2004). *A 90-nm Logic Technology Featuring Strained-Silicon*. IEEE Trans. Electron Devices, 51(11), 1790–1797.（同一技術的 IEEE 期刊版）
- Auth, C. et al. (2012). *A 22nm high performance and low-power CMOS technology featuring fully-depleted tri-gate transistors, self-aligned contacts and high density MIM capacitors*. VLSI Symposium.（Intel 22nm tri-gate + SiGe S/D 整合）
...
**參考**：
- Plummer, J. D., Deal, M. D. & Griffin, P. B. (2000). *Silicon VLSI Technology*, Prentice Hall, Ch. 7（epi growth 基礎）
- Kasper, E. & Bean, J. C. (eds.) (1988). *Silicon Molecular Beam Epitaxy*, Vols. I & II, CRC Press, Boca Raton.（Si MBE 標準參考書）
...
**參考**：
- Loubet, N. et al. (2017). *Stacked nanosheet gate-all-around transistor to enable scaling beyond FinFET*. VLSI Symposium.（IBM 公認 stacked nanosheet 論文）
- Mertens, H. et al. (2016). *Vertically stacked gate-all-around Si nanowire CMOS transistors with dual work function metal gates*. IEDM.（imec stacked nanowire 首發）
- Weckx, P. et al. (2019). *Novel forksheet device architecture as ultimate logic scaling device towards 2nm*. IEDM.（imec forksheet 首發）
...
- Mertens, H. et al. (2016). *Vertically stacked gate-all-around Si nanowire CMOS transistors with dual work function metal gates*. IEDM.（imec stacked nanowire）
- Weckx, P. et al. (2019). *Novel forksheet device architecture as ultimate logic scaling device towards 2nm*. IEDM.（imec forksheet）
- Ghani, T. et al. (2003). *A 90nm high volume manufacturing logic technology featuring novel 45nm gate length strained silicon CMOS transistors*. IEDM Tech. Dig., pp. 978–980.（Intel 90nm SiGe S/D）
- Thompson, S. E. et al. (2004). *A 90-nm Logic Technology Featuring Strained-Silicon*. IEEE TED 51(11), 1790–1797.
- Auth, C. et al. (2012). *A 22nm high performance and low-power CMOS technology featuring fully-depleted tri-gate transistors, self-aligned contacts and high density MIM capacitors*. VLSI Symposium.
- Kasper, E. & Bean, J. C. (eds.) (1988). *Silicon Molecular Beam Epitaxy*, Vols. I & II, CRC Press.
