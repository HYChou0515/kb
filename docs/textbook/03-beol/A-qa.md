...
**參考**：Black, J. R. (1969). *Electromigration—A brief survey and some recent results*. IEEE Trans. Electron Devices, 16, 338–347.
...
- Ogawa, E. T. et al. (2002). *Stress-induced voiding under vias connected to wide Cu metal leads*. IEEE IRPS.
